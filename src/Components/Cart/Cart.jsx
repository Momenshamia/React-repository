...
export default function Cart() {
  ...
  return <>
    ...
    {CartDetails?.products.length > 0 ? <>
      <h2 className='text-center text-2xl text-emerald-600 py-4 font-bold'>Total price: {CartDetails?.totalCartPrice}</h2>
    ...
    </> : <h1 className='text-3xl text-red-800 capitalize font-bold text-center my-8'>No Product Added</h1>}
